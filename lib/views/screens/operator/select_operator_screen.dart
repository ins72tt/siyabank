...
import 'package:viser_bank/data/model/airtime/operator_response_model.dart';
import 'package:viser_bank/views/components/appbar/custom_appbar.dart';
import 'package:viser_bank/views/components/buttons/custom_rounded_button.dart';
                      ...
                      children: List.generate(controller.tabsList.length, (index) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text(tabs.title?.toCapitalized() ?? "".tr.toCapitalized(),style: interMediumDefault.copyWith(color:controller.currentTab == index ? MyColor.colorWhite : MyColor.primaryColor),),
                          ),
                        );
                      })
                    ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  CustomCashNetworkImage(
                                    imageWidth: context.height * .05,
                                    imageHeight: context.height * .05,
