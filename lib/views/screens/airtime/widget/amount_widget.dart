    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(color:  selectedAmount ?MyColor.primaryColor.withOpacity(.7):MyColor.borderColor.withOpacity(.8)),
            color: selectedAmount ? MyColor.primaryColor.withOpacity(.8) : MyColor.colorWhite,
