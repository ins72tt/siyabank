    ...
    return widget.needOutline
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(borderSide: const BorderSide(width: 0.5, color: MyColor.textFieldDisableBorderColor), borderRadius: BorderRadius.circular(widget.radius)),
        ...
        interRegularDefault.copyWith(color: MyColor.getTextColor()),
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: const UnderlineInputBorder(borderSide: BorderSide(width: 0.5, color: MyColor.textFieldDisableBorderColor)),
