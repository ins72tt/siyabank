      ...
      if (model.status.toString().toLowerCase() == MyStrings.success.toLowerCase()) {
        ...
        String trx = model.data?.trx??'';
         if(nextPageUrl.isEmpty){
           ...
           }else if(nextPageUrl==RouteHelper.bottomNavBar){
             Get.offAndToNamed(nextPageUrl);
             CustomSnackBar.success(successList: [MyStrings.topUpComplete.tr]);
           } else{
